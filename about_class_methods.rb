...
class AboutClassMethods < Neo::Koan
  ...
  #
  # Answer: The first one. The second method opens up a singleton class
  # for the object.
  # Link: http://stackoverflow.com/questions/2505067/class-self-idiom-in-ruby/2505077#2505077
  #
  # ------------------------------------------------------------------
