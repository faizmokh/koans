...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # 
    # It's similar to reduce method; where it combines all elements by binary operation
  end
  ...
  # 
  # This helps to avoid leak in file handle.The lack of exception handling on the second code
  # would make the file handle leak and eventually crash the proccess running.
