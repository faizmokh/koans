...
class AboutSymbols < Neo::Koan
  ...
  # Since they're immutable and cannot be modified, you're allocating a lot of
  # memory that can't be freed until the program ends (Memory leak waiting to happen). 
  # Only dynamically create symbols if you:
