...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Repetition are greedy by default because they match as many occurences as
  # possible while still allowing overall match to succeed. See:
  # https://ruby-doc.org/core-2.1.0/Regexp.html
  ...
  #
  # Character classes are optimized for matching one out some set of characters and
  # alternation allows for more general choices of varying length.
